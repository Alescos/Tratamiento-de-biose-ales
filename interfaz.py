...
class InterfazGrafico(QMainWindow):
    ...
    def graficar_tiempo(self): 
        #'''
       # Esta funcion permite obtener un segmento cualquiera de la señal de entrada
    ...
    def graficar_filtrada(self):
        #"""
        #Esta señal grafica la señal filtrada. Recibe el canal y la señal de entrada
        #y retorna el grafico de la señal filtrada en el canal deseado
        #"""
...
#        nivel_actual = 1
    ...
    def guardar_filtrada(self):
        #"""
        #Esta función guarda la señal filtrada en un archivo .mat, haciendo uso 
        #de la función savemat de Scipy
        #"""
